...
const file_proto_agent_proto_rawDesc = "" +
	"\n" +
	"\x11proto/agent.proto\x12\tserverhub\"\a\n" +
	"\x05Empty\"J\n" +
	...
	"createDirs\"\x8d\x01\n" +
	"\tFileChunk\x122\n" +
	"\x05start\x18\x01 \x01(\v2\x1a.serverhub.FileUploadStartH\x00R\x05start\x12\x16\n" +
	"\x05chunk\x18\x02 \x01(\fH\x00R\x05chunk\x12,\n" +
	"\x03end\x18\x03 \x01(\v2\x18.serverhub.FileUploadEndH\x00R\x03endB\x06\n" +
	"\x04data\"\xd0\x01\n" +
	...
	"\n" +
	"DeleteFile\x12\x16.serverhub.FileRequest\x1a\x19.serverhub.ActionResponse\x12?\n" +
	"\n" +
	"UploadFile\x12\x14.serverhub.FileChunk\x1a\x19.serverhub.UploadResponse(\x01\x12>\n" +
	"\fDownloadFile\x12\x16.serverhub.FileRequest\x1a\x14.serverhub.FileChunk0\x01\x126\n" +
...
var file_proto_agent_proto_goTypes = []any{
	...
	(*FileChunk)(nil),            // 24: serverhub.FileChunk
	(*FileUploadStart)(nil),      // 25: serverhub.FileUploadStart
	(*FileUploadEnd)(nil),        // 26: serverhub.FileUploadEnd
	(*UploadResponse)(nil),       // 27: serverhub.UploadResponse
	(*DirRequest)(nil),           // 28: serverhub.DirRequest
	(*DirContent)(nil),           // 29: serverhub.DirContent
	(*LogRequest)(nil),           // 30: serverhub.LogRequest
	(*LogLine)(nil),              // 31: serverhub.LogLine
	(*ServiceFilter)(nil),        // 32: serverhub.ServiceFilter
	(*ServiceList)(nil),          // 33: serverhub.ServiceList
	(*ServiceInfo)(nil),          // 34: serverhub.ServiceInfo
	(*ServiceActionRequest)(nil), // 35: serverhub.ServiceActionRequest
	(*ProcessFilter)(nil),        // 36: serverhub.ProcessFilter
	(*ProcessList)(nil),          // 37: serverhub.ProcessList
...
var file_proto_agent_proto_depIdxs = []int32{
	...
	22, // 14: serverhub.DirContent.files:type_name -> serverhub.FileInfo
...
func file_proto_agent_proto_init() {
	...
	file_proto_agent_proto_msgTypes[23].OneofWrappers = []any{
		(*FileChunk_Start)(nil),
		(*FileChunk_Chunk)(nil),
		(*FileChunk_End)(nil),
	}
